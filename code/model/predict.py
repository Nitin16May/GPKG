...
''' 
This class is used for knowledge graph embedding, which is a task in which entities and relations in a knowledge graph are represented
as vectors (or embeddings) in a low-dimensional space. These embeddings can then be used for tasks like link prediction,
entity classification, and relation prediction.
'''
class GPKG_EMBEDD(BaseModel):
	def __init__(self, edge_index, edge_type, num_rel, params=None):
		...
		# print(self.p.gcn_dim)
		# print(self.init_embed)
		# print(self.device)
...
class GPKG_PREDICT(GPKG_EMBEDD):
	...
	def forward(self, sub, rel, neg_ents):
		print("forward")
		print(self.hidden_drop)
		print(self.feature_map_drop)
		print("Sub and relation")
		print(sub)
		print(rel)
